...
class EmployeeDashboardController extends Controller
{
    public function index()
    {
        ...
        $myActiveTasks = $this->getMyActiveTasks($employee->user->id)
    ...
    public function updateTaskStatus(Request $request, Task $task)
{
    ...
    $jobUser = JobUser::where('user_id', $employee->user->id)
    ...
    public function updateJobStatus(Request $request, Job $job)
    {
        ...
        $isAssigned = JobUser::where('user_id', $employee->user->id)
...
{
    $completedTasks = \App\Models\JobUser::where('user_id', $employeeId)
        ->where('status', 'completed')
        ->whereNotNull('end_date')
        ->get();
