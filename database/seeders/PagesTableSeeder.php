...
class PagesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $pages = [
            ...
            ['name' => 'View job options', 'code' => '11.4', 'page_category_id' => 11, 'active' => true],
            ['name' => 'Create job option', 'code' => '11.5', 'page_category_id' => 11, 'active' => true],
            ['name' => 'Edit job option', 'code' => '11.6', 'page_category_id' => 11, 'active' => true],
            ['name' => 'View jobs', 'code' => '11.7', 'page_category_id' => 11, 'active' => true],
            ['name' => 'Create job', 'code' => '11.8', 'page_category_id' => 11, 'active' => true],
            ['name' => 'Edit job', 'code' => '11.9', 'page_category_id' => 11, 'active' => true],
            ['name' => 'View job details', 'code' => '11.10', 'page_category_id' => 11, 'active' => true],
            ['name' => 'View job tasks', 'code' => '11.11', 'page_category_id' => 11, 'active' => true],
            ['name' => 'Create job task', 'code' => '11.12', 'page_category_id' => 11, 'active' => true],
            ['name' => 'Edit job task', 'code' => '11.13', 'page_category_id' => 11, 'active' => true],
            ['name' => 'Add job items', 'code' => '11.14', 'page_category_id' => 11, 'active' => true],
            ['name' => 'Job approval', 'code' => '11.15', 'page_category_id' => 11, 'active' => true],
            ['name' => 'View job assignments', 'code' => '11.16', 'page_category_id' => 11, 'active' => true],
            ['name' => 'Assign job', 'code' => '11.17', 'page_category_id' => 11, 'active' => true],
            ['name' => 'View job assignment details', 'code' => '11.18', 'page_category_id' => 11, 'active' => true],
            ['name' => 'Update job assignment status', 'code' => '11.19', 'page_category_id' => 11, 'active' => true],
