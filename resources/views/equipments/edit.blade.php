                    ...
                    <form action="{{ route('equipments.update', $equipment) }}" method="POST">
                        ...
                        <div class="d-component-container">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="model" id="model" class="form-control @error('model') is-invalid @enderror" value="{{ old('model', $equipment->model) }}">
                                @error('model')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="serial_number" id="serial_number" class="form-control @error('serial_number') is-invalid @enderror" value="{{ old('serial_number', $equipment->serial_number) }}">
                                @error('serial_number')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="d-com-flex justify-content-start mb-4">
                                ...
                                <label class="d-toggle position-relative" style="margin-top: 5px; margin-bottom: 3px;">
                                    <input class="form-check-input d-section-toggle" type="checkbox" name="active" {{ old('active', $equipment->active) ? 'checked' : '' }}>
                                    <span class="d-slider">
