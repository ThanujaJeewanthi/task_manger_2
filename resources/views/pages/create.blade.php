                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('code') is-invalid @enderror"
                                        id="code" name="code" value="{{ old('code') }}" placeholder="e.g. 1"
                                        required>
                                ...
                                <small class="form-text text-muted">The code will be in the format: CategoryID.PageNumber
                                </small>
                                @error('code')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control @error('page_category_id') is-invalid @enderror"
                                    ...
                                    @foreach ($categories as $id => $name)
                                        <option value="{{ $id }}"
                                            {{ old('page_category_id') == $id ? 'selected' : '' }}>{{ $name }}
                                        </option>
                                    @endforeach
                                </select>
