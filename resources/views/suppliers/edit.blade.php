                    ...
                    <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                        ...
                        <div class="d-component-container">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="3">{{ old('description', $supplier->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="d-com-flex justify-content-start mb-4">
                                ...
                                <label class="d-toggle position-relative" style="margin-top: 5px; margin-bottom: 3px;">
                                    <input class="form-check-input d-section-toggle" type="checkbox" name="active" {{ old('active', $supplier->active) ? 'checked' : '' }}>
                                    <span class="d-slider">
